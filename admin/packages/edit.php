...
<div class="px-4 py-8 max-w-2xl mx-auto md:mx-0">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Package</h1>
    ...
    <form method="post" class="space-y-4 bg-white p-6 rounded-2xl shadow">
        ...
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">Update Package</button>
    </form>
