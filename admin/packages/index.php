    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form method="post" id="bulkActionsForm">
            ...
            <div class="px-5 py-3 bg-gray-100 border-t border-gray-200 flex justify-end space-x-2">
                <button type="submit" name="action" value="bulk_activate" id="bulkActivateBtn" class="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 transition font-medium opacity-50 cursor-not-allowed" disabled onclick="return confirm('Are you sure you want to activate selected packages?');">Bulk Activate</button>
                <button type="submit" name="action" value="bulk_deactivate" id="bulkDeactivateBtn" class="bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-600 transition font-medium opacity-50 cursor-not-allowed" disabled onclick="return confirm('Are you sure you want to deactivate selected packages?');">Bulk Deactivate</button>
                <button type="submit" name="action" value="bulk_delete" id="bulkDeleteBtn" class="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition font-medium opacity-50 cursor-not-allowed" disabled onclick="return confirm('Are you sure you want to delete selected packages?');">Bulk Delete</button>
            </div>
        </form>
    </div>
